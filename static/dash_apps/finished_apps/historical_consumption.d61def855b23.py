    ...
    html.Div([
        html.Div([
            ...
            dbc.Row([
                    ...
                    ], style={'width': 'fit-content', })], style={'justify-content': 'center', 'padding-top': '1%', 'padding-left': '10%'}),

            dbc.Row([
                    dbc.Col([html.H4("Aggregated Energy", id='lineTitle', style={'margin-left': '5%'})],
                            width=5, style={'text-align': 'center', 'padding-left': '10%'}),
                    dbc.Col([
                        html.H4("Energy Breakdown Today",
                                id='pieTitle')
                    ], width=6, style={'text-align': 'center', 'padding-right': '15%'}),
                    ], style={'justify-content': 'center', 'padding-left': '20%', 'padding-top': '2%'}),
            ...
            dbc.Row([
                    ...
                    dbc.Col([
                        html.Div(dbc.Spinner(color="primary", id="loadingLine", children=[dcc.Graph(id='line-chart', config={'displayModeBar': False}),
                                                                                          ], spinner_style={
                    ...
                    dbc.Col([
                        html.Div(
                            dbc.Spinner(color="primary", id="loadingPie", children=[dcc.Graph(
                                id='pie-chart-2', config={'displayModeBar': False})], spinner_style={"width": "3rem", "height": "3rem"}),
                    ...
                    ], style={'justify-content': 'center', 'margin-left': '0px', 'padding-top': '1%'})
