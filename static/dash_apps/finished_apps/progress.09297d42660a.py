...
app.layout = html.Div([
    dbc.Row([dbc.Col([html.P('6 daily achievements and 5 weekly achievements left to claim.',
                      ...
                      html.Br(),
                      html.A("Check your wallet", href='#top')], width=7,
                     style={'padding-left': '50px', 'text-align': 'center'}),
             dbc.Col(html.Img(src="https://image.flaticon.com/icons/svg/860/860511.svg", style={'height': '150px'}),
                     style={'line-height': '75px'})],
            style={'height': '50%', 'align-items': 'baseline', 'padding': '2%'}
            ),
    ...
    dbc.Row([dbc.Col(dbc.Progress(children='9%', id='progress-bar', value=140,
             ...
             dbc.Col(
                 html.P('140/1500', style={'font-weight': 'bold', 'marginLeft': 0, 'text-align': 'left', 'padding': 0,
                                           'line-height': '40px',
                                           'height': '40px'}), width=1, style={'padding': 0})
             ]),
    html.Div([
